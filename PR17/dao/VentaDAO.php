...
class VentaDAO implements DAO{
    ...
    public static function findAll(){
        $sql = "select id_venta, usuario, fecha_compra, cod_producto, cantidad, precio_total from ventas;";
    ...
    public static function findById($idVenta){
        $sql = "select id_venta, usuario, fecha_compra, cod_producto, cantidad, precio_total from ventas where id_venta=?;";
    ...
    public static function update($objeto){
        $sql = "update ventas set id_venta=?,usuario=?,fecha_compra=?,cod_producto=?,cantidad=?,precio_total=? where id_venta=?";
    ...
    public static function save($objeto){
        $sql = "insert into ventas (id_venta,usuario,fecha_compra,cod_producto,cantidad,precio_total) values (?,?,?,?,?,?);";
